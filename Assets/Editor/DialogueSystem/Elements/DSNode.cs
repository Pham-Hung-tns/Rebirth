...
namespace DS.Elements
{
    ...
    public class DSNode : Node
    {
        ...
        public virtual void Draw()
        {
            ...
            Port inputPort = this.CreatePort("Dialogue Connection", UnityEditor.Experimental.GraphView.Orientation.Horizontal, UnityEditor.Experimental.GraphView.Direction.Input, Port.Capacity.Multi);
